"""
Django settings for lattice_surgery_web project.
...
ROOT_URLCONF = 'lattice_surgery_web.urls'
...
WSGI_APPLICATION = 'lattice_surgery_web.wsgi.application'
...
STATIC_URL = str(BASE_DIR) + '/lattice_main/static/'
